...
export default function UsagePage() {
  ...
  const devices = ["heat", "fan", "btsp", "light-red", "light-green", "light-blue", "light-white"]
  ...
  return (
    <div className="space-y-3">
      <div>
        ...
        <p className="text-muted-foreground mb-2">장치 사용량</p>
      </div>
            ...
            <div className="flex flex-col gap-3">
              {devices.map((device) => {
                ...
                return (
                  <Card key={device}>
                    <CardHeader>
                      <CardTitle className="text-lg">{deviceLabels[device]} 사용량 </CardTitle>
                    </CardHeader>
                    <CardContent>
                      {deviceData.length === 0 ? (
