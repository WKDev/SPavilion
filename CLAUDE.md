...
ls -l /dev/ttyUSB*
sudo minicom -D /dev/ttyUSB0 -b 115200     # Test serial connection
...
**Connection**: USB-RS232 → /dev/ttyUSB0, Modbus RTU, 115200 baud, 8N1
...
- `components/` - React components organized by feature (layout, dashboard, device, usaㅍㅍge, providers)
